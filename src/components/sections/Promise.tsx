    ...
    <section className="promise">
      ...
      <div className="wrap">
        ...
        <h2 className="display reveal promise-title">
          ...
          <span className="hand-highlight">they are capable of more.</span>
        </h2>
        <p className="reveal">
          A student. A colleague. A child. A stranger. Do not tell them about the movement. Do not tell them about
          the book. Just help them see themselves differently.
        </p>
