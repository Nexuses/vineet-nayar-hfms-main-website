...
export function AuthorHero() {
  return (
    <section className="ah-hero" id="author-hero" aria-labelledby="author-hero-heading">
      <div className="ah-hero-grid">
        <div className="ah-left reveal">
          <h2 className="ah-headline" id="author-hero-heading">
          ...
          <p className="ah-quote reveal">{AUTHOR_HERO_QUOTE}</p>
      ...
      <div className="ah-cred-bar reveal">
